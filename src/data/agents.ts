...
export const funnelStages: FunnelStage[] = [
  ...
  },
  {
    ...
    agents: [
      { id: slug('Predictive Account Scoring'), name: 'Predictive Account Scoring', description: 'Score accounts based on fit, intent, and likelihood to convert.', stage: 'Account Prioritization', stageSlug: 'account-prioritization', status: 'coming-soon', icon: BarChart3, details: 'Machine learning models that score accounts based on ideal customer profile fit, intent signals, engagement history, and conversion probability.' },
      { id: slug('Ranking & Explainability'), name: 'Ranking & Explainability', description: 'Rank accounts with transparent, explainable scoring logic.', stage: 'Account Prioritization', stageSlug: 'account-prioritization', status: 'coming-soon', icon: Target, details: 'Not just scores but explanations. Understand exactly why an account is ranked high or low, which signals contributed, and what actions to take next.' },
      { id: slug('Account Prioritization Agent'), name: 'Account Prioritization Agent', description: 'Automatically prioritize your pipeline based on real-time signals.', stage: 'Account Prioritization', stageSlug: 'account-prioritization', status: 'coming-soon', icon: TrendingUp, details: 'End-to-end account prioritization that combines scoring, ranking, and real-time signal updates to keep your pipeline always sorted by opportunity.' },
    ],
  },
  {
    ...
    agents: [
      { id: slug('LinkedIn Message Generator'), name: 'LinkedIn Message Generator', description: 'Generate personalized LinkedIn messages that get responses.', stage: 'Messaging & Outreach', stageSlug: 'messaging-outreach', status: 'live', icon: MessageSquare, details: 'AI-generated LinkedIn messages tailored to each prospect based on their profile, company, and intent signals. Achieve higher response rates with hyper-personalization.' },
      { id: slug('Multi-Channel Outreach Agent'), name: 'Multi-Channel Outreach Agent', description: 'Orchestrate outreach across email, LinkedIn, and other channels.', stage: 'Messaging & Outreach', stageSlug: 'messaging-outreach', status: 'coming-soon', icon: Mail, details: 'Coordinate messaging across multiple channels with optimal timing and sequencing. Manage multi-touch campaigns that feel personal at scale.' },
      { id: slug('Follow-Up Intelligence Agent'), name: 'Follow-Up Intelligence Agent', description: 'Smart follow-ups based on prospect engagement and timing signals.', stage: 'Messaging & Outreach', stageSlug: 'messaging-outreach', status: 'coming-soon', icon: RefreshCw, details: 'Intelligent follow-up scheduling based on prospect behavior, email opens, LinkedIn activity, and optimal timing windows. Never miss the right moment to re-engage.' },
    ],
  },
  {
  ...
  },
  {
    ...
    agents: [
      ...
      { id: slug('CRM Update Agent'), name: 'CRM Update Agent', description: 'Keep your CRM updated with the latest account intelligence.', stage: 'Data & Ops', stageSlug: 'data-ops', status: 'coming-soon', icon: RotateCcw, details: 'Automatically push enriched data, intent signals, and account updates back to your CRM. Keep your source of truth always current without manual data entry.' },
